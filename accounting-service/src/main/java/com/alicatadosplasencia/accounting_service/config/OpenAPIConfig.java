package com.alicatadosplasencia.accounting_service.config;
...
public class OpenAPIConfig {
    ...
    public OpenAPI accountingServiceOpenAPI() {
        ...
        gatewayServer.setUrl("http://localhost:8080/api/accounting");
        ...
        Info info = new Info()
                ...
                .version("1.0.0")
                .description("API REST para gestión de facturación y contabilidad de servicios")
                .contact(contact)
                .license(license);
